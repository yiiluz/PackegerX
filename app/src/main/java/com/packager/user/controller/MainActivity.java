...
public class MainActivity extends AppCompatActivity {
    ...
    private static Configuration.SignInMethod signInMethod;
    private static EditText phoneLoginInput;
    ...
    private static Address deviceAddress;
...
//        }
        ...
        loginWithPhone = findViewById(R.id.loginWithPhoneButton);
        phoneLoginInput = findViewById(R.id.editTextPhoneNumber);

        loginWithPhone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v)
            {
                String phoneNumber = phoneLoginInput.getText().toString();
                if (phoneNumber.length() != 10){
                    phoneLoginInput.setError("This is not a phone number !");
                    phoneLoginInput.requestFocus();
                }
                else{
                            ...
                            .addOnCompleteListener(MainActivity.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        signInMethod = Configuration.SignInMethod.EMAIL;
                                        dialog.hide();
    ...
    public static Address getDeviceAddress() {
    ...
    public static EditText getPhoneLoginInput() {
        return phoneLoginInput;
    }

    public static void setPhoneLoginInput(EditText phoneLoginInput) {
        MainActivity.phoneLoginInput = phoneLoginInput;
    }

    public static void setSignInMethod(Configuration.SignInMethod signInMethod) {
        MainActivity.signInMethod = signInMethod;
    }

    public static Configuration.SignInMethod getSignInMethod() {
        return MainActivity.signInMethod;
    }
                                ...
                                .addOnCompleteListener(MainActivity.this, new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            currUserMail = mAuth.getCurrentUser().getEmail();
                                            signInMethod = Configuration.SignInMethod.GOOGLE;
                                            dialog.hide();
                                            startActivity(new Intent(MainActivity.this, NewHomeActivity.class));
                                        } else {
                                            dialog.hide();
    ...
    public static void setDeviceAddress(Address deviceAddress) {
    ...
    private void resolveAddressFromLatAndLng() {
        ...
        deviceAddress = new Address(lat, lng, address);
